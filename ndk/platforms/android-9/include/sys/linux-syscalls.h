...
#define __NR_socket                       (__NR_SYSCALL_BASE + 326)
#define __NR_socketpair                   (__NR_SYSCALL_BASE + 333)
#define __NR_bind                         (__NR_SYSCALL_BASE + 327)
#define __NR_connect                      (__NR_SYSCALL_BASE + 328)
#define __NR_listen                       (__NR_SYSCALL_BASE + 329)
#define __NR_accept                       (__NR_SYSCALL_BASE + 330)
#define __NR_getsockname                  (__NR_SYSCALL_BASE + 331)
#define __NR_getpeername                  (__NR_SYSCALL_BASE + 332)
#define __NR_sendto                       (__NR_SYSCALL_BASE + 335)
#define __NR_recvfrom                     (__NR_SYSCALL_BASE + 337)
#define __NR_shutdown                     (__NR_SYSCALL_BASE + 338)
#define __NR_setsockopt                   (__NR_SYSCALL_BASE + 339)
#define __NR_getsockopt                   (__NR_SYSCALL_BASE + 340)
#define __NR_sendmsg                      (__NR_SYSCALL_BASE + 341)
#define __NR_recvmsg                      (__NR_SYSCALL_BASE + 342)
#define __NR___socketcall                 (__NR_SYSCALL_BASE + 102)
