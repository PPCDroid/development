...
#define PS3AV_RES_MASK_60 (PS3AV_RESBIT_720x480P   | PS3AV_RESBIT_1280x720P   | PS3AV_RESBIT_1920x1080I   | PS3AV_RESBIT_1920x1080P)
#define PS3AV_RES_MASK_50 (PS3AV_RESBIT_720x576P   | PS3AV_RESBIT_1280x720P   | PS3AV_RESBIT_1920x1080I   | PS3AV_RESBIT_1920x1080P)
...
#define PS3AV_RES_MASK_VESA (PS3AV_RESBIT_WXGA |  PS3AV_RESBIT_SXGA |  PS3AV_RESBIT_WUXGA)
...
#define PS3AV_PKT_AVB_PARAM_MAX_BUF_SIZE   (PS3AV_AVB_NUM_VIDEO*sizeof(struct ps3av_pkt_video_mode) +   PS3AV_AVB_NUM_AUDIO*sizeof(struct ps3av_pkt_audio_mode) +   PS3AV_AVB_NUM_AV_VIDEO*sizeof(struct ps3av_pkt_av_video_cs) +   PS3AV_AVB_NUM_AV_AUDIO*sizeof(struct ps3av_pkt_av_audio_param))
